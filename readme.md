...
You only need a web browser (like Chrome, Firefox, or Edge) to view the site.
...
2.  **Navigate to the project directory:**
    ...
    ```
3.  **Open the file:**
    Locate the `index.html` file in the directory and **double-click** it, or open your web browser and navigate to the file path (`file:///path/to/BookShop/index.html`).

---

## 📂 Project Structure (Based on HTML)

The project relies on a standard file structure:
...
**Nahiyan Khan** (as credited in the footer)